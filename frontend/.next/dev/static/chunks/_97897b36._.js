...
function Home() {
    ...
    if ($[2] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = ({
            "Home[HandleChange]": (e)=>{
                ...
                setFormData({
                    "Home[HandleChange > setFormData()]": (prev)=>({
                            ...prev,
                            [name]: value
                        })
                }["Home[HandleChange > setFormData()]"]);
            }
        })["Home[HandleChange]"];
        $[2] = t1;
    } else {
    ...
    let t2;
    if ($[3] !== dispatch || $[4] !== formData || $[5] !== router) {
        t2 = ({
            "Home[HandleLogIn]": async (e_0)=>{
                ...
                try {
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Benvenuto!");
                    router.replace("/dashboard");
                } catch  {
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Accesso negato");
                }
            }
        })["Home[HandleLogIn]"];
        $[3] = dispatch;
...
_s(Home, "E5SO8U53Td7O9grNupeufImvwrg=", false, function() {
    return [
...
//# sourceMappingURL=_97897b36._.js.map