...
;
const LogIn = (formData)=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$apiClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('login/', formData);
_c = LogIn;
const LogOut = ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$apiClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('logout/');
_c1 = LogOut;
const CheckUser = ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$apiClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('user_check/');
_c2 = CheckUser;
var _c, _c1, _c2;
...
function AppWrapper(t0) {
    ...
    if ($[0] !== "7643768eaac27b86670bcc1722f695a15c5078f86be32adb43f7660aacdaa76d") {
        for(let $i = 0; $i < 5; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "7643768eaac27b86670bcc1722f695a15c5078f86be32adb43f7660aacdaa76d";
    }
    const { children } = t0;
...
_s(AppWrapper, "4AZSeRIv5k8qD794E0UAz4kqF7g=", false, function() {
    return [
...
//# sourceMappingURL=src_62cae174._.js.map